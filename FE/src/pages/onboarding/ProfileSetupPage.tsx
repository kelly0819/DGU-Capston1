    ...
    <AppLayout>
      <section className="flex min-h-screen flex-col px-6 pb-8 pt-10">
        <div>
          ...
          >
            <div className="relative mx-auto flex h-[120px] w-[120px] items-center justify-center rounded-full border border-gray-200 bg-white">
              ...
              <span className="absolute bottom-2 right-0 flex h-9 w-9 items-center justify-center rounded-full border-4 border-white bg-primary-500">
                <svg
                  aria-hidden="true"
        ...
        <button
          className="mt-auto h-14 w-full rounded-xl bg-primary-500 text-body1  text-white"
